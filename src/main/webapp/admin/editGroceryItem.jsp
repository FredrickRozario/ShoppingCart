...
<body>
 <h2><a class="back" href="allGroceryItemsEditGroceryItems.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></h2>
<%
...
try
{
	...
	{
	%>
<form action="editGroceryItemAction.jsp" method="post">
...
<div class="left-div">
 ...
 <input class="input-style" name="manufacturingDate" value="<%=rs.getString(4) %>" type="text" required>
<hr>
</div>

<div class="right-div">
<h3>Enter Best Before Date</h3>
 <input class="input-style" name="bestBeforeDate" value="<%=rs.getString(5) %>" type="text" required>
