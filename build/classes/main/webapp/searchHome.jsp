...
%>
          <tr>
            ...
            <td><i class="fa fa-inr"></i><i> <%=rs.getString(6) %></i></td>
             <td><a href="addToCartAction.jsp?id=<%=rs.getString(1)%>&category=<%=rs.getString(3)%>">Add to cart <i class='fas fa-cart-plus'></i></a></td>
          </tr>
          <%
	}
}
